...
!!! tip
    Токен нужно получить тут [https://vkhost.github.io](https://vkhost.github.io) (выберите VK Admin, согласитесь со всем и скопируйте часть адресной строки от `access_token=` до `&expires_in`)
