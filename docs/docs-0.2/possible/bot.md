Терминальный инструемент `bot` — ~~гордость vkquick~~ незаменимый помощник при работе с проектами. Вместо копипастов и поисков рабочего кода вам нужно лишь написать нужную команду
