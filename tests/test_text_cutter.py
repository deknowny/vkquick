...
usages_description = [
    ...
    (
        vq.UserMention(),
        "Аргумент является упоминанием пользователя.",
    ),
    (
        vq.GroupMention(),
        "Аргумент является упоминанием группы.",
    ),
    (
        vq.String(),
    ...
    (
        vq.List(vq.Integer()),
        vq.Integer().usage_description() + " Минимальное количество подобных аргументов больше или равно 1, "
    ...
    (
        ...
        vq.Integer().usage_description() + " Передаваемое значение может быть полностью пропущено."
    ),
    (
