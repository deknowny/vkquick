...
from vkquick.chatbot_extension.ui_builders.base import UIBuilder
from vkquick.chatbot_extension.ui_builders.button import InitializedButton


class Keyboard(UIBuilder):

    # Пустая клавиатура. Используйте при отправке, чтобы удалить текущую
