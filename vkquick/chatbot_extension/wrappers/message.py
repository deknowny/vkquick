...
from vkquick.bases.wrapper import Wrapper
from vkquick.utils import cached_property, peer
from vkquick.json_parsers import json_parser_policy
from vkquick.chatbot_extension.wrappers.attachment import Document, Photo
...
class Message(Wrapper):
    ...
    @property
    def action(self) -> ty.Optional[dict]:
